...
class DashBoardProvider extends ChangeNotifier {
  ...
  addProduct() async {
    try {
      ...
      Map<String, dynamic> formDataMap = {
        ...
        'offerPrice': productOffPriceCtrl.text.isEmpty ? productPriceCtrl.text.isEmpty : productOffPriceCtrl.text,
  ...
  filterVariant(VariantType variantType) {
    ...
    final List<String> variantsNames = newList.map((variant) => variant.name ?? '').toList();
    variantsByVariantType = variantsNames;
    notifyListeners();
  }
